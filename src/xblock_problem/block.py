...
from xblock_problem.markup import HTML, Text
from xblocks_core.legacy_utils.xml_utils import LegacyXmlMixin, is_pointer_tag
...
class ProblemBlock(ScorableXBlockMixin, LegacyXmlMixin, XBlock):
    ...
    numeric response, true/false, etc. See src/xblock_problem/capa/responsetypes.py
