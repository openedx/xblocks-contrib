...
from xblocks_core.legacy_utils.xml_utils import (
    EdxJSONEncoder,
    LegacyXmlMixin,
    deserialize_field,
    is_pointer_tag,
...
from .ajax_handler_mixin import AjaxHandlerMixin
from .bumper_utils import bumperize
from .cache_utils import request_cached
from .constants import ATTR_KEY_REQUEST_COUNTRY_CODE, ATTR_KEY_USER_ID, PUBLIC_VIEW, STUDENT_VIEW
from .exceptions import TranscriptNotFoundError
from .mixin import LicenseMixin
from .studio_metadata_mixin import StudioMetadataMixin
from .validation import StudioValidation, StudioValidationMessage
from .video_handlers import VideoStudentViewHandlers, VideoStudioViewHandlers
from .video_static_content_utils import compute_location, get_location_from_path, serialize_asset_key_with_slash
from .video_transcripts_utils import (
...
class VideoBlock(
    ...
    def parse_xml(cls, node, runtime, _keys):
        ...
        scope_ids = ScopeIds(None, block_type, definition_id, usage_id)
        video = runtime.construct_xblock_from_class(cls, scope_ids)
            ...
            if video_config_service:
                try:
                    transcript = video_config_service.get_transcript(
                        self, lang=language, output_format=TranscriptExtensions.TXT
                    )[0].replace("\n", " ")
