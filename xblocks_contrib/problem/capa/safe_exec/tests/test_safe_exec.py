...
class TestCodeJailDarkLaunch(unittest.TestCase):
    ...
    @patch("xblocks_contrib.problem.capa.safe_exec.safe_exec.get_remote_exec")
    @patch("xblocks_contrib.problem.capa.safe_exec.safe_exec.codejail_safe_exec")
    ...
    def run_dark_launch(
        ...
        with (
            patch("xblocks_contrib.problem.capa.safe_exec.safe_exec.codejail_safe_exec") as mock_local_exec,
            patch("xblocks_contrib.problem.capa.safe_exec.safe_exec.get_remote_exec") as mock_remote_exec,
            patch("xblocks_contrib.problem.capa.safe_exec.safe_exec.set_custom_attribute") as mock_set_custom_attribute,
            patch("xblocks_contrib.problem.capa.safe_exec.safe_exec.log.info") as mock_log_info,
        ):
    ...
    @patch("xblocks_contrib.problem.capa.safe_exec.safe_exec.record_exception")
    @patch("xblocks_contrib.problem.capa.safe_exec.safe_exec.log.error")
...
class DictCache(object):  # pylint: disable=useless-object-inheritance
