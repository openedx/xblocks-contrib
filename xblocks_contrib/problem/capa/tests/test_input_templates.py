...
class TemplateTestCase(unittest.TestCase):
    ...
    def render_to_xml(self, context_dict):
        ...
        try:
            ...
            raise TemplateError(exceptions.text_error_template().render()) from exc
        ...
        try:
            ...
            raise TemplateError("Could not parse XML from '{0}': {1}".format(xml_str, str(exc))) from exc
        return xml
...
class FormulaEquationInputTemplateTest(TemplateTestCase):
    """
    Test make template for `<formulaequationinput>`.
    """
