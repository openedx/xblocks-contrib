...
from xblocks_contrib.problem.capa.tests.helpers import load_fixture, new_loncapa_problem
    ...
    @data(
        ...
        },
        {
            ...
            'expected_string': (
                ...
                '<div class="explanation-title">Answer</div>'
                '<span class="hint-label">Correct: </span>'
                '<div class="hint-text">Less well known, but yes, '
                'there is a Paris, Texas.&#937;</div></div>'
            ),
        },
        {
            'problem_id': '1_2_1',
        ...
        },
        {
            ...
            'expected_string': (
                ...
                '<div class="explanation-title">Answer</div>'
                '<span class="hint-label">Incorrect: </span>'
                '<div class="hint-text">The country name does not end '
                'in LAND&#937;</div></div>'
            ),
        },
        {
            ...
            'expected_string': (
                ...
                '<div class="explanation-title">Answer</div>'
                '<span class="hint-label">Correct: </span>'
                '<div class="hint-text">The red light is scattered by '
                'water molecules leaving only blue light.</div></div>'
            ),
        },
        {
            'problem_id': '1_3_1',
...
class TextInputExtendedHintsCaseSensitive(HintTest):
    ...
    @data(
        ...
        {
            'problem_id': '1_6_1', 'choice': 'C',
            'expected_string': (
                '<div class="feedback-hint-incorrect"><div class="explanation-title">Answer</div>'
                '<span class="hint-label">Incorrect: </span><div class="hint-text">hint4</div></div>'
            ),
        },
        {'problem_id': '1_6_1', 'choice': 'c', 'expected_string': ''},
        # regexp cases
        {
            'problem_id': '1_6_1', 'choice': 'FGG',
            'expected_string': (
                '<div class="feedback-hint-incorrect"><div class="explanation-title">Answer</div>'
                '<span class="hint-label">Incorrect: </span><div class="hint-text">hint6</div></div>'
            ),
        },
...
class TextInputExtendedHintsCompatible(HintTest):
    ...
    @data(
        ...
        # check going through conversion with difficult chars
        {
            ...
            'correct': 'correct', 'expected_string': ''
        },
    )
    @unpack
    ...
    @data(
        {
            ...
            'expected_string': (
                '<div class="feedback-hint-correct">'
                '<div class="explanation-title">Answer</div>'
                '<span class="hint-label">Nice </span>'
                '<div class="hint-text">'
    ...
    @data(
        {
            ...
            'expected_string': (
                ...
                '<div class="hint-text">What is a camero anyway?</div>'
                '</div></div>'
            )
        },
        {
        ...
        },
        {
            ...
            'expected_string': (
                ...
                '<div class="hint-text">You are right that mushrooms are not fruit</div>'
                '<div class="hint-text">Remember that grape is also a fruit.</div>'
                '<div class="hint-text">I do not know what a Camero is but it is not a fruit.</div>'
                '</div></div>'
            ),
        },
        {
            ...
            'expected_string': (
                '<div class="feedback-hint-incorrect">'
                '<div class="explanation-title">Answer</div>'
                '<span class="hint-label">Almost right </span>'
                '<div class="hint-text">You are right that apple is a fruit, but there is one you are missing. '
                'Also, mushroom is not a fruit.</div>'
                '</div>'
            ),
        },
        {
            ...
            'expected_string': (
                ...
                '<div class="explanation-title">Answer</div>'
                '<span class="hint-label">Incorrect: </span>'
                '<div class="hint-text">You are right that grape is a fruit, but there is one you are missing. '
                'Also, mushroom is not a fruit.</div>'
                '</div>'
            ),
        },
        ...
        },
        {
            ...
            'expected_string': (
                ...
                '<div class="hint-text">Brussel sprout is the only vegetable in this list.</div>'
                '</div></div>'
            ),
        },
        {
        ...
        },
        {
            ...
            'expected_string': (
                ...
                '<div class="hint-text">poor banana.</div>'
                '<div class="hint-text">You are right that mushrooms are not vegatbles</div>'
                '<div class="hint-text">Brussel sprouts are vegetables.</div>'
                '</div></div>'
            ),
        },
        {
            ...
            'expected_string': (
                ...
                '<div class="hint-text">Making a banana split?</div>'
                '</div>'
            ),
        },
        {
        ...
        # These are some tricky cases
        {
            ...
            'expected_string': (
                '<div class="feedback-hint-correct">'
                '<div class="explanation-title">Answer</div>'
                '<span class="hint-label">AA </span>'
                '<div class="feedback-hint-multi">'
                '<div class="hint-text">aa</div>'
                '</div>'
                '</div>'
            ),
        },
        ...
        },
        {
            ...
            'expected_string': (
                '<div class="feedback-hint-correct">'
                '<div class="explanation-title">Answer</div>'
                '<div class="hint-text">compoundo</div>'
                '</div>'
            ),
        },
    ...
    @data(
        ...
        },
        {
            ...
            'expected_string': (
                ...
                '<span class="hint-label">Incorrect: </span>'
                '<div class="hint-text">'
                'Potato is <img src="#" ale="#"/> not a fruit.'
                '</div>'
                '</div>'
            ),
        },
    ...
    @data(
        {
            ...
            'expected_string': (
                '<div class="feedback-hint-correct">'
                '<div class="explanation-title">Answer</div>'
                '<span class="hint-label">Good Job </span>'
                '<div class="hint-text">'
        ...
        },
        {
            ...
            'expected_string': (
                '<div class="feedback-hint-incorrect">'
                '<div class="explanation-title">Answer</div>'
                '<span class="hint-label">NOPE </span>'
                '<div class="hint-text">'
