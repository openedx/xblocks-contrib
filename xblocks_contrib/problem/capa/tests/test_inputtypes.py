...
class MatlabTest(unittest.TestCase):
    ...
    def test_get_html(self):
        ...
        self.the_input.capa_system.render_template = lambda *args: (
            textwrap.dedent(
...
class TestChoiceText(unittest.TestCase):
    ...
    def check_group(self, tag, choice_tag, expected_input_type):
        ...
        xml_str = (
            "<{tag}>\n"
            "    <{choice_tag} correct=\"false\" name=\"choiceinput_0\">"
            "this is<numtolerance_input name=\"choiceinput_0_textinput_0\"/>false"
            "</{choice_tag}>\n"
            "    <choice correct=\"true\" name=\"choiceinput_1\">"
            "Is a number<decoy_input name=\"choiceinput_1_textinput_0\"/><text>!</text>"
            "</choice>\n"
            "</{tag}>\n"
        ).format(
            tag=tag,
