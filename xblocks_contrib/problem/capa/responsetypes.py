...
from xblocks_contrib.problem.capa.xqueue_interface import DATEFORMAT, make_hashkey, make_xheader
...
class CodeResponse(LoncapaResponse):
    ...
    def get_score(self, student_answers):  # pylint: disable=too-many-locals
        ...
        if is_list_of_files(submission):
            ...
            error, msg = qinterface.send_to_queue(header=xheader, body=json.dumps(contents), files_to_upload=submission)
        else:
