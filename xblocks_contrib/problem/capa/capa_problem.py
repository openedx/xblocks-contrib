...
class LoncapaProblem(object):  # pylint: disable=useless-object-inheritance
    """
    ...
    def __init__(
        ...
        id,
        capa_system,
        capa_block,  # pylint: disable=too-many-positional-arguments,redefined-builtin
        state=None,
        seed=None,
        minimal_init=False,
        extract_tree=True,
    ...
    def make_xml_compatible(self, tree):
        ...
        1. <additional_answer> compatibility translation::
            ...
            convert to
            new: <additional_answer answer="ANSWER">OPTIONAL-HINT</additional_answer>
