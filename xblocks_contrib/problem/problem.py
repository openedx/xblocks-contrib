...
from xblocks_contrib.problem.fields import Date, ListScoreField, RelativeTime, ScoreField, Timedelta
...
class ProblemBlock(ScorableXBlockMixin, XBlock):
    ...
    def student_view(self, _context=None, show_detailed_errors=False):
        """
        ...
        fragment.add_javascript(resource_loader.load_unicode("static/js/vendor/CodeMirror/codemirror.js"))
    ...
    def studio_view(self, _context):
        ...
        context["gettext"] = self.runtime.service(self, "i18n").gettext
        fragment.add_content(render_to_string("problem.html", context))
        fragment.add_css(resource_loader.load_unicode("static/css/problem_editor.css"))
        fragment.add_javascript(resource_loader.load_unicode("static/js/src/edit.js"))
    ...
    def handle_ajax(self, dispatch, data):
        ...
        try:
            ...
            log.warning(
                "NotFoundError in problem %s for user %s. Returning 200 with error payload as per test requirements.",
                self.scope_ids.usage_id,
                self.scope_ids.user_id,
            )
            # The test expects a 200 response with the error message under a 'success' key.
            # Create this specific payload.
            response_payload = {"success": not_found_error_message}
    ...
    def non_editable_metadata_fields(self):
        ...
        non_editable_fields = [XBlock.tags, XBlock.name]
