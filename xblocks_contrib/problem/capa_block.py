...
class ProblemBlock(  # pylint: disable=too-many-public-methods,too-many-instance-attributes,too-many-ancestors
    ...
    def parse_xml(cls, node, runtime, keys):
        ...
        field_data = KvsFieldData(InheritanceKeyValueStore(initial_values=field_data))
    ...
    def student_view(self, _context, show_detailed_errors=False):
        ...
        fragment.add_css_url(self.runtime.local_resource_url(self, "problem/public/css/ProblemBlockDisplay.css"))
        fragment.add_javascript_url(self.runtime.local_resource_url(self, "problem/public/js/ProblemBlockDisplay.js"))
