function genex() {
  var P = "",
    ...
    _ = "/",
    lb = "//",
    Qb = "21B31BA00E7CE7B6BD63DD13A8586A45",
    Rb = "63308EE54E8033A708B414CAC05B0C32",
    Sb = "7AC57DC6EC8C1D8672DDF6E6D4EF57CC",
    Tb = "9B4F4D4EFA24CDE2E4287CC07897F249",
    Wb = ":",
    pb = "::",
    dc = "<script defer=\"defer\">genex.onInjectionDone('genex')<\/script>",
    hb = '<script id="',
    sb = "=",
    $ = "?",
    Ub = "A069AC107D79C29D6237614AC340F0C0",
    ub = 'Bad handler "',
    Vb = "C6220FCC8B9234FEAD8D826A73C6D2A4",
    cc = "DOMContentLoaded",
    jb = "SCRIPT",
    gb = "__gwt_marker_genex",
    kb = "base",
    cb = "baseUrl",
    T = "begin",
    S = "bootstrap",
  ...
  genex.onScriptLoad = function () {
    if (I) {
      r = true;
      C();
    }
  };
  genex.onInjectionDone = function () {
    q = true;
