function protex() {
  var P = "",
    ...
    _ = "/",
    lb = "//",
    Qb = "39CC89519B0E1FCB47B935AC9FE13D7B",
    Rb = "6E05B1CD5BFCAF7D53C7C64D84318178",
    Wb = ":",
    pb = "::",
    dc = "<script defer=\"defer\">protex.onInjectionDone('protex')<\/script>",
    hb = '<script id="',
    sb = "=",
    $ = "?",
    ub = 'Bad handler "',
    Sb = "C824A958AB642DC2213DFFDAC640BEAA",
    Tb = "D9267DE8FB02F8B995B4A58C66C76E29",
    cc = "DOMContentLoaded",
    Ub = "F275492F7098103BCB05F4F86ABF6218",
    Vb = "F3301B0E65F38C7FCF2EF3764B3BB0B6",
    jb = "SCRIPT",
    gb = "__gwt_marker_protex",
    kb = "base",
    cb = "baseUrl",
    T = "begin",
    S = "bootstrap",
  ...
  protex.onScriptLoad = function () {
    if (I) {
      r = true;
      C();
    }
  };
  protex.onInjectionDone = function () {
    q = true;
  ...
  function O() {
    if (!s) {
      s = true;
      if (!__gwt_stylesLoaded[Yb]) {
        var a = n.createElement(Zb);
        __gwt_stylesLoaded[Yb] = a;
        a.setAttribute($b, _b);
        a.setAttribute(ac, t + Yb);
        n.getElementsByTagName(bc)[0].appendChild(a);
      }
      C();
      if (n.removeEventListener) {
        n.removeEventListener(cc, O, false);
      }
      if (N) {
        clearInterval(N);
      }
