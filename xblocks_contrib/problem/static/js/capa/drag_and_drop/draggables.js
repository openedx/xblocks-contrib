        ...
        draggableObj.iconImgEl.load(function () {
          ...
          if (draggableObj.originalConfigObj.label.length > 0) {
            draggableObj.labelEl = $(
              HtmlUtils.joinHtml(
                HtmlUtils.HTML('<div style="position: absolute; color: black; font-size: 0.95em; " role="label">'),
        ...
        draggableObj.iconImgEl.load(function () {
          ...
          if (draggableObj.iconWidth >= draggableObj.iconHeight) {
            ...
            draggableObj.iconHeightSmall =
              draggableObj.iconWidthSmall * (draggableObj.iconHeight / draggableObj.iconWidth);
          } else {
            draggableObj.iconHeightSmall = 60;
            draggableObj.iconWidthSmall =
              draggableObj.iconHeightSmall * (draggableObj.iconWidth / draggableObj.iconHeight);
          }
          ...
          if (obj.label.length > 0) {
            draggableObj.labelEl = $(
              HtmlUtils.joinHtml(
                HtmlUtils.HTML('<div style=" position: absolute; color: black; font-size: 0.95em; cursor: move; " >'),
                obj.label,
                HtmlUtils.HTML("</div>"),
              ).toString(),
            );
