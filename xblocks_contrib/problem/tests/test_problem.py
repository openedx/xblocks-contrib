...
class ProblemBlockTest(unittest.TestCase):  # lint-amnesty, pylint: disable=missing-class-docstring
    ...
    def test_rescore_problem_correct(self):
        ...
        with patch('xblocks_contrib.problem.capa.responsetypes.LoncapaResponse.evaluate_answers') as mock_evaluate_answers:
    ...
    def test_rescore_problem_not_supported(self):
        ...
        # Try to rescore the problem, and get exception
        with patch('xblocks_contrib.problem.capa.capa_problem.LoncapaProblem.supports_rescoring') as mock_supports_rescoring:
    ...
    def test_get_score_with_grading_method_calls_grading_method_handler(self):
        ...
        with patch('xblocks_contrib.problem.GradingMethodHandler') as mock_handler:
    ...
    def _rescore_problem_error_helper(self, exception_class):
        ...
        # Simulate answering a problem that raises the exception
        with patch('xblocks_contrib.problem.capa.capa_problem.LoncapaProblem.get_grade_from_current_answers') as mock_rescore:
    ...
    @patch('xblocks_contrib.problem.log')
    @patch('xblocks_contrib.problem.Progress')
