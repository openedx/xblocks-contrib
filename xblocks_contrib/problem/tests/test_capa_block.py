...
class ProblemBlockTest(unittest.TestCase):  # pylint: disable=too-many-public-methods
    ...
    def test_submit_problem_correct(self):
        ...
        with patch("xblocks_contrib.problem.capa.correctmap.CorrectMap.is_correct") as mock_is_correct:
            with patch("xblocks_contrib.problem.capa_block.ProblemBlock.get_problem_html") as mock_html:
    ...
    @patch("xblocks_contrib.problem.capa_block.ProblemBlock.get_score_with_grading_method")
    @patch("xblocks_contrib.problem.capa.correctmap.CorrectMap.is_correct")
    @patch("xblocks_contrib.problem.capa_block.ProblemBlock.get_problem_html")
    ...
    def test_submit_problem_grading_method_disable_to_enable(self, mock_html: Mock, mock_is_correct: Mock):
        ...
        with patch(
            "xblocks_contrib.problem.capa_block.ProblemBlock.is_grading_method_enabled",
    ...
    def test_submit_problem_closed(self):
        ...
        with patch("xblocks_contrib.problem.capa_block.ProblemBlock.closed") as mock_closed:
    ...
    @patch("xblocks_contrib.problem.capa_block.ProblemBlock.get_rescore_with_grading_method")
    ...
    @patch("xblocks_contrib.problem.capa_block.ProblemBlock.publish_grade")
    ...
    @patch("xblocks_contrib.problem.capa_block.ProblemBlock.score_from_lcp")
    ...
    def test_get_score_with_grading_method_calls_grading_method_handler(self):
        ...
        with patch("xblocks_contrib.problem.capa_block.GradingMethodHandler") as mock_handler:
    ...
    @patch("xblocks_contrib.problem.capa_block.render_to_string")
    ...
    @patch("xblocks_contrib.problem.capa_block.log")
...
class ProblemBlockReportGenerationTest(unittest.TestCase):
    ...
    def test_generate_report_data_report_loncapa_error(self):
        ...
        block = self._get_block()
        with patch("xblocks_contrib.problem.capa_block.LoncapaProblem") as mock_loncapa_problem:
