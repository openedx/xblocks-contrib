...
from xblocks_contrib.problem.contentstore.content import StaticContent
from xblocks_contrib.problem.contentstore.django import contentstore
from xblocks_contrib.problem.sandboxing import SandboxService, can_execute_unsafe_code
...
class SandboxingTest(TestCase):
    ...
    def test_courselikes_with_unsafe_code_default(self):
        ...
        e.g. we don't use @override_settings in these tests
        """
...
class SandboxServiceTest(TestCase):
    ...
    PYTHON_LIB_SOURCE_FILE = "xblocks_contrib/problem/tests/data/uploads/python_lib.zip"
