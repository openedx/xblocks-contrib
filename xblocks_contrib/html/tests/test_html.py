...
from xblocks_contrib.html.html import ATTR_KEY_DEPRECATED_ANONYMOUS_USER_ID, HtmlBlock
...
def get_test_system(
    ...
    class StubUserService:
        ...
        def get_current_user(self):
            """Mock user object with opt_attrs."""
            mock_user = Mock()
            mock_user.opt_attrs = {ATTR_KEY_DEPRECATED_ANONYMOUS_USER_ID: "test-user-id"}
            return mock_user
