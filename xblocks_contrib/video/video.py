...
class VideoBlock(
    ...
    def youtube_deprecated(self):
        ...
        return video_config_service.is_youtube_deprecated(self.location.course_key)
    ...
    def index_dictionary(self):
        ...
        def _update_transcript_for_index(language=None):
            ...
            try:
                video_config_service = self.runtime.service(self, 'video_config')
                transcript = video_config_service.get_transcript(self, lang=language, output_format=Transcript.TXT)[0].replace("\n", " ")
