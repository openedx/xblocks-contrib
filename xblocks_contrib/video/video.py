...
class VideoBlock(
    ...
    def get_html(self, view=STUDENT_VIEW, context=None): # lint-amnesty, pylint: disable=arguments-differ, too-many-statements
        ...
        if getattr(self, 'video_speed_optimizations', True) and cdn_url:
            branding_info = get_branding_info(self)
        ...
        if self.is_public_sharing_enabled():
            ...
            # TODO: Move all the code below to video config service
            # organization = get_course_organization(self, self.course_id)
            # if organization:
    ...
    def get_course_video_sharing_override(self):
        ...
        try:
            course = get_course_by_id(self, self.context_key)
            if course:
    ...
    #     # TODO: Add new changes introduced in this commit: https://github.com/openedx/edx-platform/commit/797438e91b6e58452fa1efe102bafd6d7d2da765#diff-0c437f410aa8b98a76aa91ccd72e2b9c2da8c49f09168fa66ed63861529eebaf
    ...
    #             # TODO: Add new changes introduced in this commit: https://github.com/openedx/edx-platform/commit/b6489e718cc5f640c71213a6ff5e886faa582af8#diff-0c437f410aa8b98a76aa91ccd72e2b9c2da8c49f09168fa66ed63861529eebaf
