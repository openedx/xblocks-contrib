# NOTE: This mixin is copied from the following files: 
# https://github.com/openedx/edx-platform/blob/master/xmodule/x_module.py#L624-L714
# https://github.com/openedx/edx-platform/blob/master/xmodule/video_block/video_block.py#L674-L726

from django.conf import settings
from xblock.core import XBlock
from xblock.fields import (Integer, Scope, Float, List, Dict, String)

from xblocks_contrib.video.exceptions import NotFoundError
from xblocks_contrib.video.transcripts_utils import Transcript, get_html5_ids, get_transcript
...
class StudioMetadataMixin:
    ...
    # TODO: Review if we needs to merge this method within editable_metadata_fields
