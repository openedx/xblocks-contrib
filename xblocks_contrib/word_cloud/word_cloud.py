...
def resource_string(resource_path):
    """Handy helper for getting resources from our kit."""
    return importlib.resources.files(__package__).joinpath(resource_path.lstrip('/')).read_text()
...
class WordCloudXBlock(StudioEditableXBlockMixin, XBlock):
    ...
    def student_view(self, context=None):  # pylint: disable=W0613
        ...
        frag.add_content(resource_loader.render_django_template(
            "static/html/word_cloud_xblock.html", {
        ...
        frag.add_css(resource_string("static/css/word_cloud_xblock.css"))
        frag.add_javascript(resource_string("static/js/src/word_cloud_xblock.js"))
        frag.add_javascript(resource_string("static/js/src/d3.min.js"))
        frag.add_javascript(resource_string("static/js/src/d3.layout.cloud.js"))
        frag.add_javascript(resource_string("static/js/src/html_utils.js"))
